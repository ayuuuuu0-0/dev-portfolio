...
const DiscordIcon = (className, ...rest) => (
  ...
  >
    <path
      d="M116.25.55C92.55 2.8 70 11.603 50.55 26.149c-6.198 4.602-19.8 18.204-24.402 24.403-34.796 46.597-34.796 108.3 0 154.898 4.602 6.2 18.204 19.801 24.403 24.403 46.597 34.796 108.3 34.796 154.898 0 6.2-4.602 19.801-18.204 24.403-24.403 34.796-46.597 34.796-108.3 0-154.898-4.602-6.2-18.204-19.801-24.403-24.403C179.45 6.75 147.551-2.398 116.25.551ZM108.8 74.8l1.802 3.75 5.097-.402c6.45-.5 18.102-.5 24.602 0l5.05.403 1.848-3.852L149 70.852l2.55.347c5.802.801 17.95 4.45 25.598 7.7 3.25 1.351 3.454 1.55 6.204 5.902 10.75 17.05 17.148 35 19.398 54.148.8 6.551 1 18.653.398 24l-.296 3.153-3.801 2.648c-4.5 3.2-12.5 7.648-19.051 10.7-4.55 2.05-13.898 5.55-14.95 5.55-.652 0-4.402-5.352-6.75-9.602-1.75-3.097-1.8-3.449-.948-3.699 2.398-.898 11.046-5.097 11.347-5.597.153-.301-.3-.954-1.05-1.5l-1.399-.954-4.75 1.903c-11.75 4.699-19.7 6.148-33.5 6.148s-21.75-1.449-33.5-6.148l-4.75-1.903-1.398.954c-.75.546-1.204 1.199-1.051 1.5.3.449 8.949 4.699 11.347 5.546.801.301.75.653-.949 3.704-2.347 4.25-6.148 9.648-6.75 9.648-1.05 0-10.449-3.5-14.949-5.55-6.55-3.052-14.55-7.5-19.05-10.7l-3.802-2.648-.296-3.903c-1.204-13.75.648-31.148 4.699-44.648 3.097-10.352 8.75-22.653 15.05-32.801l2.797-4.5 5.954-2.352c8.25-3.25 20.449-6.699 24.25-6.847 1.199-.051 1.546.347 3.199 3.75Zm0 0"
      style={{
        stroke: "none",
        fillRule: "nonzero",
        fill: "#000",
    ...
    />
    <path
      d="M99.75 119.05c-2.852.7-5.75 2.848-7.602 5.65-2 2.948-2.648 5.152-2.648 9.152 0 8.296 5.898 14.75 13.5 14.699 3.45 0 5.648-.852 8.2-3.051 5.1-4.5 6.6-12.2 3.652-18.648-2.75-6-9.102-9.25-15.102-7.801ZM150.352 119.05c-4.102 1-7.5 3.95-9.454 8.2-1.546 3.352-1.597 9.45-.046 12.8 5 11.098 18.847 11.45 24.199.65 1-2.052 1.199-3.2 1.199-7.2 0-5.2-.7-7.2-3.7-10.602-2.8-3.199-8.1-4.847-12.198-3.847Zm0 0"
      style={{
        stroke: "none",
        fillRule: "nonzero",
        fill: "#000",
