...
const Skills = () => {
  return (
    <>
      <h2 className="font-bold text-8xl mt-64 w-full text-center md:text-6xl md:mt-32 font-mont">
        Skills
      </h2>
      <div
      ...
      >
        ...
        <Skill name="Docker" x="40vw" y="-12vw" />
        <Skill name="Etherium" x="-20vw" y="20vw" />
      </div>
    </>
  );
};
