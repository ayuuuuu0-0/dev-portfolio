        ...
        <main className="flex w-full flex-col items-center justify-content dark:text-light">
          <Layout>
            ...
            <div className="grid w-full grid-cols-8 gap-16">
              ...
              <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light dark:bg-dark p-8 dark:border-light">
              ...
              <div className="col-span-2 flex flex-col items-end justify-between">
                <div className="flex flex-col items-end justify-center">
                  <span className="inline-block text-7xl font-bold font-mont">
                    <AnimatedNumbers value={20} />+
                  </span>
                  <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light/75 font-mont">
                    projects completed
                  </h2>
                </div>
