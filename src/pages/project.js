  ...
  return (
    <article className="w-full flex items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12  dark:bg-dark dark:border-light">
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6">
        <span className="text-primary font-medium text-xl dark:text-primaryDark font-mont">
          {type}
        </span>
        <Link
          href={link}
        ...
        >
          <h2 className="my-2 w-full text-left text-4xl font-bold dark:text-light font-mont">
            {title}
          </h2>
        </Link>
        <p className="my-2 font-medium text-dark dark:text-light  font-mont">
          {summary}
        </p>
...
const Project = ({ title, type, img, link, github }) => {
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border border-light">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <Link href={link} target="_blank" className="hover:underline-offset-2">
          <h2 className="my-2 w-full text-left text-3xl font-bold font-mont">
            {title}
          </h2>
        </Link>
        <div className="w-full mt-2 flex items-center justify-between">
          <Link
            href={link}
            target="_blank"
            className="text-lg font-semibold font-mont underline"
          >
            Visit
          </Link>
          <Link href={github} target="_blank" className="w-10">
